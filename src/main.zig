...
fn printControls() void {
    std.debug.print("  W/S         - Move camera closer/farther\n", .{});
    std.debug.print("  A/D         - Rotate camera horizontally\n", .{});
    ...
    std.debug.print("  +/-         - Adjust disk brightness\n", .{});
...
pub fn main() !void {
    ...
    const window = glfw.glfwCreateWindow(1920, 1080, "meem", null, null);
    ...
    while (glfw.glfwWindowShouldClose(window) == glfw.GLFW_FALSE) {
        ...
        // Set additional uniforms if they exist
